...
## Project Structure
    ...
    ├── testappgenera_dev_44743  # Django project configurations
...
1. Clone this repo and `cd testappgenera_dev_44743`
...
2. Clone this repo and `cd testappgenera_dev_44743`
